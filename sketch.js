...
function draw() {
  ...
  textSize(18)
  start = text("To Start the Game press the Up Arrow, use the Up Arrow to move up and press the down arrow to move down, be careful not go off screen or you lose,if you also get stopped by a platform you lose, GOOD LUCK", sewerman.x - 100, 100)
